...
/// @see WithLevel
static ara::log::LogStream LogFatal() {
...
/// @see WithLevel
static ara::log::LogStream LogError() {
...
/// @see WithLevel
static ara::log::LogStream LogWarn() {
...
/// @see WithLevel
static ara::log::LogStream LogInfo() {
...
/// @see WithLevel
static ara::log::LogStream LogDebug() {
...
/// @see WithLevel
static ara::log::LogStream LogVerbose() {
