...
TEST_F(CoreErrorDomainTest, Message_ReturnsCorrectMessage) {
    ...
    EXPECT_STREQ(error_domain.Message(static_cast<ara::core::ErrorDomain::CodeType>
                                (ara::core::CoreErrc::kInvalidMetaModelShortname)), "Invalid Meta Model Shortname");
    EXPECT_STREQ(error_domain.Message(static_cast<ara::core::ErrorDomain::CodeType>
                                (ara::core::CoreErrc::kInvalidMetaModelPath)), "Invalid Meta Model Path");
}
TEST(MakeErrorCodeTest, MakeErrorCode_CreatesCorrectErrorCode) {
    ara::core::ErrorDomain::SupportDataType data = "123";
    ara::core::ErrorCode error_code = ara::core::MakeErrorCode(ara::core::CoreErrc::kInvalidArgument, data);
    EXPECT_EQ(error_code.Value(), static_cast<ara::core::ErrorDomain::CodeType>(ara::core::CoreErrc::kInvalidArgument));
