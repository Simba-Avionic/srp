...
from tools.someip.addition_method_parameters import Addends, Sum
...
async def main():
    ...
    service_instance_addition2 = await construct_server_service_instance(
        addition_service,
        instance_id=SAMPLE_INSTANCE_ID+8,
        endpoint=(
            ipaddress.IPv4Address(INTERFACE_IP),
            3002,
        ),  # src IP and port of the service
    ...
    service_discovery.attach(service_instance_addition2)
    ...
    service_instance_addition2.start_offer()
...
#         someip_sd_header = SomeIpSdHeader.from_buffer(received)
#         # print("test1233")
#         print("------------------"+str(i))
