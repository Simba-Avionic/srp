...
class DtcController:public IDtcController{
  ...
  */
  core::ErrorCode RegisterError(uint16_t &dtc_error_id,uint8_t &dtc_status,std::vector<uint8_t> &payload) override;
  void Init(com::soc::SocketConfig &config) override;
