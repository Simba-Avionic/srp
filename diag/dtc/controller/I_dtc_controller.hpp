...
public:
 virtual void Init(com::soc::SocketConfig &config)=0;

 virtual core::ErrorCode RegisterError(uint16_t &dtc_error_id,uint8_t &dtc_status,std::vector<uint8_t> &payload)=0;
