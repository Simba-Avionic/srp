...
const std::uint16_t CRC16::calculate(const uint8_t& data) {
...
const std::uint16_t CRC16::calculate(const uint16_t& data) {
  return CRC16::calculate(
      {static_cast<uint8_t>(data >> 8), static_cast<uint8_t>(data)});
}
const std::uint16_t CRC16::calculate(const uint32_t& data) {
  return CRC16::calculate(
      {static_cast<uint8_t>(data >> 24), static_cast<uint8_t>(data >> 16),
       static_cast<uint8_t>(data >> 8), static_cast<uint8_t>(data)});
}
const std::uint16_t CRC16::calculate(const uint64_t& data) {
  return CRC16::calculate(
      {static_cast<uint8_t>(data >> 56), static_cast<uint8_t>(data >> 48),
       static_cast<uint8_t>(data >> 40), static_cast<uint8_t>(data >> 32),
       static_cast<uint8_t>(data >> 24), static_cast<uint8_t>(data >> 16),
       static_cast<uint8_t>(data >> 8), static_cast<uint8_t>(data)});
}
