...
DtcDatabaseElement::DtcDatabaseElement(
    uint16_t service_id, std::string details,
...
uint16_t DtcDatabaseElement::GetService_id() { return this->service_id_; }

std::string DtcDatabaseElement::GetDetails() { return this->details_; }
DtcErrorStatus_t DtcDatabaseElement::GetStatus() { return this->status_; }
