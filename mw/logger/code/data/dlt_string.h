 ...
 *
 */
#ifndef MW_LOGGER_CODE_DATA_DLT_STRING_H_
#define MW_LOGGER_CODE_DATA_DLT_STRING_H_
#include <algorithm>
#include <cstdint>
#include <string>
#include <vector>
...
class DltString : IDLTArg {
 ...
 public:
  DltString() = default;
  explicit DltString(const simba::dlt::data::DltString& other) { log = other.log; }
...
#endif  // MW_LOGGER_CODE_DATA_DLT_STRING_H_
