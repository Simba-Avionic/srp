...
#ifndef APPS_EC_RADIO_SERVICE_RADIO_APP_H_
...
#include "srp/apps/FcRadioServiceSkeleton.h"
#include "mw/gpio_server/controller/gpio_controller.hpp"
#include "apps/ec/radio_service/telemetry_provider.hpp"
#include "apps/ec/radio_service/someip_controller.hpp"
#include "apps/ec/radio_service/radio_controller.hpp"
#include "apps/ec/radio_service/gs_hb_guider.hpp"
...
class RadioApp : public ara::exec::AdaptiveApplication {
 private:
  ...
  apps::FcRadioServiceSkeleton service_ipc;
  apps::FcRadioServiceSkeleton service_udp;
...
#endif  // APPS_EC_RADIO_SERVICE_RADIO_APP_H_
