...
TEST(GPSAppTest2, ParseGPSData_InvalidData_ReturnsNullopt) {
    std::vector<uint8_t> invalidData{'$', 'G', 'P', 'I', 'N', 'V', ',', '1', '2', '3', ',', 'N'};
...
TEST(GPSAppTest2, ParseGPSData_EmptyData_ReturnsNullopt) {
...
TEST(GPSAppTest2, ParseGPSData_IncompleteGNGGA_ReturnsNullopt) {
    std::vector<uint8_t> incompleteData{
...
TEST(GPSAppTest2, ParseGPSData_ZeroSatellites_ReturnsNullopt) {
    std::vector<uint8_t> zeroSatellitesData{
...
TEST_P(GPSAppTest, ParseGPSData) {
    ...
    std::vector<uint8_t> vec(param.input.begin(), param.input.end());
    auto res = srp::apps::GPSApp::ParseGPSData(vec);
